      ...
      <div className="projects-container">
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <p>
              This project showcases a modern stone facade for a residential
              property, featuring clean lines and a combination of natural stone
              textures that provide a contemporary look.
            </p>
          </div>
        </div>
        <div className="project-item">
          <div className="project-content">
            ...
            <p>
              We built an elegant garden wall using carefully selected stones to
              blend seamlessly with the surrounding landscape, enhancing the
              natural beauty of the garden space.
            </p>
          </div>
